...
# Date: 02/09/26
# Description: This program asks the user various questions, that then lead the code to reccomend the user a specific snack.
#-----------------------------------------------------------------
...
def main():
    ...
    if flavor == "sweet":                                                                        # Function to figure out what snack to give user                                                                   # "If" statement to categorize if snack will be savory or sweet
            ...
            if chocolate == "yes":
                ...
                if calories == "high":                                                            # Correalating "If" statement 
            ...
            if spicy == "yes":
                calories = input("Would you like your snack to have high or low calories?: ")
                if calories == "high":
